...
// CODE HERE
function sayHelloHvr() {
    sayHelloButton.style.backgroundColor = "black";
    sayHelloButton.style.color = "white";
}

sayHelloButton.addEventListener('mouseover', sayHelloHvr);
...
// CODE HERE
function sayHelloHvrOff() {
    sayHelloButton.style.backgroundColor = "white";
    sayHelloButton.style.color = "black";
}

sayHelloButton.addEventListener('mouseout', sayHelloHvrOff);
...
queryBtn.addEventListener('mouseover', testOne)
